...
class ssSytemMetaboxEngine
{
	...
	private $ssBranch_meta_key_branch = 'ss-setting'; // TODO : changes name 

	public function __construct($fields, $ssBranch_meta_key_branch, $SaveMethodSingle = false)
	{

		$this->meta_key = $ssBranch_meta_key_branch;
        ...
        <div class="background_attachment_metabox_container">';
				...
				case 'media-gallery':
					...
					echo '<li class="' . $values['class_li'] . '" id="' . $values['name'] . '_li">
	                            ...
	                            <input type="button" name="uploader" class="ss-stytem-upload-button button button-primary" value="' . __('Add Images', 'uama_wp_branch') . '">
	                            </div>
	                            </div>
	                            </div>
	                      </li>';
